...
describe("Dashboard Component", () => {
  ...
  it("should show subscription plan information", () => {
    ...
    const percentUsed =
      (subscription.messagesUsed / subscription.messagesQuota) * 100;
  ...
  it("should filter conversations by bot", () => {
    ...
    const bot1Conversations = allConversations.filter(
      (c) => c.botId === "bot-1",
    );
...
describe("Settings Page Component", () => {
  ...
  it("should mask API key display", () => {
    const fullKey = "sk_test_1234567890abcdefghijklmnopqrstuvwxyz";
    const maskedKey =
      fullKey.substring(0, 15) + "..." + fullKey.substring(fullKey.length - 5);
  ...
  it("should display all pricing plans", () => {
    const plans = [
      ...
      { name: "Starter", price: 999, features: ["3 bots", "1000 messages"] },
      {
        name: "Professional",
        price: 2999,
        features: ["10 bots", "10000 messages"],
      },
...
describe("Lead Management Component", () => {
  ...
  it("should export leads to CSV", () => {
    const leads = [{ email: "john@example.com", name: "John", score: 85 }];
...
describe("Knowledge Base Management Component", () => {
  ...
  it("should show total chunks count", () => {
    const documents = [{ chunks: 10 }, { chunks: 15 }, { chunks: 20 }];
