...
interface FloatingCardProps {
  className?: string;
  children: ReactNode;
  animationProps?: any; // we'll fix framer-motion types below
}
...
export default function HomePage() {
  ...
  const itemVariants: Variants = { hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.6, ease: [0.25, 0.1, 0.25, 1] } } };
  const scrollAnimationVariants: Variants = { hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 0.6, ease: [0.25, 0.1, 0.25, 1] } } };
  ...
  return (
    <main className="min-h-screen font-sans text-white bg-black overflow-x-hidden">
        ...
        <div className="hidden lg:grid grid-cols-6 gap-8 items-center">
          ...
          <div className="col-span-1 flex flex-col gap-y-24">
            <FloatingCard
              ...
              animationProps={{
                ...
                animate: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.25, 0.1, 0.25, 1], delay: 0.6 } },
                whileHover: { scale: 1.05 },
              }}
            >
              <div className="flex items-center gap-2 text-slate-400 mb-2">
                <MessageIcon />
                <p className="text-xs">Chats Completed</p>
              </div>
            ...
            <FloatingCard
              ...
              animationProps={{
                initial: { opacity: 0, y: 50 },
                animate: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.25, 0.1, 0.25, 1], delay: 0.8 } },
                whileHover: { scale: 1.05 },
              }}
            >
              <div className="flex items-center gap-2 text-slate-400 mb-2">
                <SmileIcon />
                <p className="text-xs">Increased Customer Satisfaction</p>
              </div>
          ...
          <div className="col-span-1 flex flex-col gap-y-24">
            <FloatingCard
              ...
              animationProps={{
                initial: { opacity: 0, y: 50 },
                animate: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.25, 0.1, 0.25, 1], delay: 0.7 } },
                whileHover: { scale: 1.05 },
              }}
            >
              <div className="flex items-center gap-2 text-slate-400 mb-2">
                <ClockIcon />
                <p className="text-xs">100+ Hours of Time Saved</p>
              </div>
            ...
            <FloatingCard
              ...
              animationProps={{
                initial: { opacity: 0, y: 50 },
                animate: { opacity: 1, y: 0, transition: { duration: 0.8, ease: [0.25, 0.1, 0.25, 1], delay: 0.9 } },
                whileHover: { scale: 1.05 },
              }}
            >
              <div className="flex items-center gap-2 text-slate-400 mb-2">
                <ArrowDownIcon />
                <p className="text-xs">Reduce Support Costs</p>
              </div>
      ...
      <section id="features" className="relative z-10 px-6 py-20 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text
