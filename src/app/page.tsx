...
const FloatingCard: React.FC<{ className?: string; children: React.ReactNode; animationProps?: any }> = ({ className, children, animationProps }) => (
  <motion.div
    {...animationProps}
    ...
    <main className="min-h-screen font-sans text-white bg-black overflow-x-hidden">
      ...
      <section className="relative w-full max-w-7xl mx-auto px-6 pt-16 pb-32 z-10">
        ...
        <div className="lg:hidden text-center">
          <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, ease: easeOut }} className="text-5xl md:text-7xl font-bold tracking-tighter leading-tight">
            India’s Smartest AI Chatbot <br />
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent whitespace-nowrap"> for E-Commerce </span>
          </motion.h1>
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2, ease: easeOut }} className="text-slate-400 text-lg max-w-xl mx-auto mt-6 mb-10">
            Paste your business info and deploy a smart chatbot on your website in minutes. No code needed. Made for Indian sellers.
          </motion.p>
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4, ease: easeOut }} className="flex justify-center items-center gap-4">
            <a href="/dashboard" className="bg-blue-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-blue-700 transition-colors"> Try it Free </a>
            <a href="/widget" className="bg-slate-800 text-white px-6 py-3 rounded-full font-semibold hover:bg-slate-700 transition-colors"> View Demo </a>
          </motion.div>
        </div>
      ...
      {/* Keep your original code here; all motion transitions use `easeOut` now */}
