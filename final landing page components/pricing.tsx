    ...
    <div>
      ...
      <div className="max-w-sm mx-auto grid gap-6 lg:grid-cols-4 items-start lg:max-w-none">
        ...
        <PricingTab
          ...
          planDescription="Perfect for getting started with customer support."
          ctaLabel="Start Free"
          features={[
            'Core AI Chatbot',
            'Lead Capture',
        ...
        <PricingTab
          yearly={isAnnual}
          planName="Basic"
          price={{ yearly: 499, monthly: 499 }}
          planDescription="For growing stores needing more conversations."
          features={[
            'Core AI Chatbot',
            'Lead Capture',
            '1,000 Replies/month',
        ...
        <PricingTab
          ...
          popular={true}
          planName="Pro"
          price={{ yearly: 1499, monthly: 1499 }}
          planDescription="Most popular for established e-commerce stores."
          features={[
            'Core AI Chatbot',
        ...
        {/* Pricing tab 4 - Enterprise */}
        <PricingTab
          yearly={isAnnual}
          planName="Enterprise"
          price={{ yearly: 2999, monthly: 2999 }}
          planDescription="For high-volume stores and teams that need more power."
          features={[
            'Core AI Chatbot',
            'Advanced Lead Capture',
