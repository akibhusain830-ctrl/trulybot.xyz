  ...
  return (
    <div className="bg-black text-white py-[72px] sm:py-24" ref={containerRef}>
      ...
      <Image src={EmojiImage} alt="emoji" className="absolute -top-[120px] right-[calc(100%+30px)]" />
        ...
        <h2 className="font-bold text-5xl sm:text-6xl tracking-tighter text-center">Get Instant Access</h2>
        <p className="text-xl text-white/70 mt-5 text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo, veritatis? Omnis minima quisquam error accusamus?</p>
